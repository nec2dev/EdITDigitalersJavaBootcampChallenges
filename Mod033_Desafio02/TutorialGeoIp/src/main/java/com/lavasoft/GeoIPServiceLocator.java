...
public class GeoIPServiceLocator extends org.apache.axis.client.Service implements com.lavasoft.GeoIPService {
 ...
 */
    ...
    public com.lavasoft.GeoIPServiceSoap getGeoIPServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.lavasoft.GeoIPServiceSoapStub _stub = new com.lavasoft.GeoIPServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.lavasoft.GeoIPServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.lavasoft.GeoIPServiceSoapStub _stub = new com.lavasoft.GeoIPServiceSoapStub(new java.net.URL(GeoIPServiceSoap_address), this);
                _stub.setPortName(getGeoIPServiceSoapWSDDServiceName());
                return _stub;
            }
        }
