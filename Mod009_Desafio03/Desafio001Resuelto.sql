...
/*5. Visualizar las tablas existentes en la base
de datos para verificar la creación de la
tabla “AGENDA”.*/
#SHOW TABLES;
...
/*INSERT INTO AGENDA
VALUES (1, 'LUCIANO', 'FERNANDEZ', 'MARTIN RODRIGUEZ 1271', 1156485201,
'L.FERNANDEZ@GMAIL.COM'),
(2, 'SEBASTIÁN', 'GARCÍA', 'LARREA 567', 1152421100,
'SEBASTIAN.GARCIA@HOTMAIL.COM'),
(3, 'CAROLINA', 'SANCHEZ', 'AV. CORRIENTES 2233 - 4ºB', 1132295741,
'CARO.GARCIA@GMAIL.COM'),
(4, 'SABRINA', 'DIAZ', 'CONSTITUCIÓN 3220 - 2ºA', 1128541025,
'SABRI.DIAZ@HOTMAIL.COM')
;*/

/*1. Crear una base de datos con el nombre
“LIBRERIA”. Poner en uso la base de datos
generada.*/
...
/*1. A partir de lo realizado en el Ejercicio 2, luego
de insertar los registros, se debe definir claves
primarias (Primary Key) en cada tabla.
Tener en cuenta que cada tabla tiene un
campo con el sufijo _id que identifica al
campo clave.*/
